...
try:
    emotion = np.load("C:/Users/Deshmukh/Desktop/liveEmoji-main/emotion.npy")[0]
except:
    emotion = ""
...
# code to load and print the saved emotion
emotion_array = np.load("emotion.npy")
recognized_emotion = str(emotion_array[0])
